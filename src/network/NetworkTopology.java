    ...
    public static class Builder {
        ...
        public NetworkTopology build() {
            ...
            for (Domain d : nt.domainList) {
                ...
                do {
                    origin = d.getRoutableList().get(new Random().nextInt(d.getRoutableList().size()));
                } while (!(origin instanceof Router));
                route.setOrigin(origin);
                Routable destination = null;
                do {
                    destination = targetD.getRoutableList().get(new Random().nextInt(targetD.getRoutableList().size()));
